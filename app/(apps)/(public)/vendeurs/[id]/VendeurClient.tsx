...
export default function VendeurClient({ id }: { id: string }) {
      ...
      <div className="max-w-5xl mx-auto px-4 -mt-6 space-y-6 pb-12">
        <div className="bg-white rounded-3xl p-6 lg:p-8 shadow-sm border border-gray-100">
          <div className="flex flex-col sm:flex-row gap-5">
            <div className="w-24 h-24 bg-gradient-to-br from-[#2d5a1b]/10 to-[#2d5a1b]/05 rounded-3xl flex items-center justify-center font-extrabold text-3xl text-[#2d5a1b] flex-shrink-0 overflow-hidden border-4 border-white shadow-lg shadow-green-900/10">
        ...
        <div>
          <div className="flex items-center justify-between mb-5">
            <h2 className="text-xl font-extrabold text-gray-900 tracking-tight">Produits</h2>
          ...
          {products.length === 0 ? (
            <div className="bg-white rounded-3xl p-16 text-center border border-gray-100">
              ...
              <p className="text-gray-400 text-sm">Cette boutique n a pas encore de produit</p>
            </div>
          ) : (
